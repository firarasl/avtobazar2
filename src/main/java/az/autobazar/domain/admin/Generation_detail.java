...
public class Generation_detail {
    private Long id;
    private String name;
    ...
    public Generation_detail(Long id, String name, Generation generation, Date from_year, Date to_year, Date insert_date, Date update_date) {
        this.id = id;
        this.name = name;
